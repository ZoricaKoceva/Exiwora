...
namespace EShop.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<EShopApplicationUser> userManager, SignInManager<EShopApplicationUser> signInManager, RoleManager<IdentityRole> roleManager)
        {
